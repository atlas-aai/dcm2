...
[![R package version](https://www.r-pkg.org/badges/version/dcm2)](https://cran.r-project.org/package=dcm2)
[![Package downloads](https://cranlogs.r-pkg.org/badges/grand-total/dcm2)](https://cran.r-project.org/package=dcm2)
[![R-CMD-check](https://github.com/atlas-aai/dcm2/workflows/R-CMD-check/badge.svg)](https://github.com/atlas-aai/dcm2/actions)</br>
[![Codecov test coverage](https://codecov.io/gh/atlas-aai/dcm2/branch/main/graph/badge.svg)](https://app.codecov.io/gh/atlas-aai/dcm2?branch=main)
[![Netlify Status](https://api.netlify.com/api/v1/badges/b82caf01-0611-4f8b-bbca-5b89b5a80791/deploy-status)](https://app.netlify.com/sites/dcm2/deploys)
[![Signed by](https://img.shields.io/badge/Keybase-Verified-brightgreen.svg)](https://keybase.io/jeffreychoover)
![License](https://img.shields.io/badge/License-GPL_v3-blue.svg)
<!-- badges: end -->

The goal of dcm2 is to provide a generic function for calculating the $M_2$ statistic described by [Liu et al. (2016)](https://doi.org/10.3102/1076998615621293).
